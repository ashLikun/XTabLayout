...
public class XTabLayoutOld extends HorizontalScrollView {
    ...
    private Drawable tabItemBackground = null;
    private Drawable tabItemSelectedBackground = null;
    ...
    public XTabLayoutOld(Context context) {
        this(context, null);
    }

    public XTabLayoutOld(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XTabLayoutOld(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        tabTextAllCaps = a.getBoolean(R.styleable.XTabLayout_xTabTextAllCaps, false);
        ...
        if (a.hasValue(R.styleable.XTabLayout_xTabItemBackground)) {
            tabItemBackground = a.getDrawable(R.styleable.XTabLayout_xTabItemBackground);
        }
        if (a.hasValue(R.styleable.XTabLayout_xTabItemSelectedBackground)) {
            tabItemSelectedBackground = a.getDrawable(R.styleable.XTabLayout_xTabItemSelectedBackground);
        }
...
//        invalidate();
     ...
     * @attr ref R.styleable#TabLayout_xTabIndicatorColor
     */
     ...
     * 设置指示器的Drawable
     *
     * @attr ref R.styleable#tabIndicatorDrawable
     */
     ...
     * @attr ref R.styleable#TabLayout_xTabIndicatorHeight
     */
    ...
    public void setTabItemBackground(Drawable tabItemBackground) {
        if (this.tabItemBackground == tabItemBackground) {
            return;
        }
    ...
    public void setTabItemSelectedBackground(Drawable tabItemSelectedBackground) {
        if (this.tabItemSelectedBackground == tabItemSelectedBackground) {
            return;
        }
        this.tabItemSelectedBackground = tabItemSelectedBackground;
        if (mSelectedTab != null) {
            selectTab(mSelectedTab);
        }
    }
    ...
    /**
     * @deprecated Use {@link #addOnTabSelectedListener(XTabLayoutOld.OnTabSelectedListener)} and
     * {@link #removeOnTabSelectedListener(XTabLayoutOld.OnTabSelectedListener)}.
     */
    @Deprecated
    public void setOnTabSelectedListener(@Nullable XTabLayoutOld.OnTabSelectedListener listener) {
    ...
    /**
     * Add a {@link XTabLayoutOld.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
     * <p>Components that add a listener should take care to remove it when finished via
     * {@link #removeOnTabSelectedListener(XTabLayoutOld.OnTabSelectedListener)}.</p>
     *
     * @param listener listener to add
     */
    public void addOnTabSelectedListener(@NonNull XTabLayoutOld.OnTabSelectedListener listener) {
    ...
    /**
     * Remove the given {@link XTabLayoutOld.OnTabSelectedListener} that was previously added via
     * {@link #addOnTabSelectedListener(XTabLayoutOld.OnTabSelectedListener)}.
     *
     * @param listener listener to remove
     */
    public void removeOnTabSelectedListener(@NonNull XTabLayoutOld.OnTabSelectedListener listener) {
        mSelectedListeners.remove(listener);
    }

    /**
     * Remove all previously added {@link XTabLayoutOld.OnTabSelectedListener}s.
     */
     ...
     * @attr ref R.styleable#TabLayout_xTabMode
     */
    ...
    /**
     * Returns the current mode used by this {@link XTabLayoutOld}.
     *
     * @see #setTabMode(int)
     */
    @XTabLayoutOld.Mode
     ...
     * Sets the text colors for the different states (normal, selected) used for the tabs.
     *
     * @attr ref R.styleable#TabLayout_xTabTextColor
     * @attr ref R.styleable#TabLayout_xTabSelectedTextColor
     */
    ...
    /**
     * The one-stop shop for setting up this {@link XTabLayoutOld} with a {@link ViewPager}.
     * <p>
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public void setSelected(boolean selected) {
            ...
            if (!selected) {
                ...
                mTextView.setTypeface(Typeface.defaultFromStyle(tabTextBold ? Typeface.BOLD : Typeface.NORMAL));
            }
            if (changed && selected) {
                setBackground(tabItemSelectedBackground);
            ...
            if (mTextView != null) {
                ...
                if (textSize != curTextSize || (curMaxLines >= 0 && maxLines != curMaxLines)) {
                    ...
                    if (updateTextView) {
                        ...
                        if (mTextView.isSelected()) {
                            mTextView.setTypeface(Typeface.defaultFromStyle(tabTextSelectedBold ? Typeface.BOLD : Typeface.NORMAL));
                        } else {
                            mTextView.setTypeface(Typeface.defaultFromStyle(tabTextBold ? Typeface.BOLD : Typeface.NORMAL));
                        }
    ...
    public class SlidingTabStrip extends LinearLayout {
         ...
         */
        private boolean tabDividerWidthText = false;
        //指示器的对齐方式
        ...
        public void setWidthText(boolean b) {
            if (tabDividerWidthText != b) {
                tabDividerWidthText = b;
     ...
     * necessary calls back to the provided {@link XTabLayoutOld} so that the tab position is
     * kept in sync.
     * <p>
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<XTabLayoutOld> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(XTabLayoutOld tabLayout) {
        ...
        public void onPageScrolled(int position, float positionOffset,
            ...
            final XTabLayoutOld tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
