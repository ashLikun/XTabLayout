...
import com.ashlikun.xtablayout.XTabLayout.SlidingTabIndicator;
import com.ashlikun.xtablayout.XTabLayout.TabView;
 ...
 * XTabLayout#isTabIndicatorFullWidth()} and linearly move the indicator between tabs.
 *
 * <p>Subclasses can override {@link #setIndicatorBoundsForTab(XTabLayout, View, Drawable)} and
 * {@link #updateIndicatorForOffset(XTabLayout, View, View, float, Drawable)} (XTabLayout, View, View,
 ...
 * #calculateIndicatorWidthForTab(XTabLayout, View)} and {@link
...
class TabIndicatorInterpolator {
     ...
     * selected.
     *
     * <p>This method accounts for {@link XTabLayout#isTabIndicatorFullWidth()}'s value. If true, the
     ...
     *
     * @param tabLayout The tab's parent {@link XTabLayout}
     ...
     */
    static RectF calculateIndicatorWidthForTab(XTabLayout tabLayout, @Nullable View tab) {
        if (tab == null) {
            return new RectF();
        }
        if (tabLayout.getTabIndicatorWidth() > 0) {
            int tabViewCenterX = (tab.getLeft() + tab.getRight()) / 2;
            return new RectF(tabViewCenterX - tabLayout.getTabIndicatorWidth(), tab.getTop(), tabViewCenterX + tabLayout.getTabIndicatorWidth(), tab.getBottom());
        }
     ...
     *
     * @param tabLayout The {@link XTabLayout} parent of the tab and indicator being drawn.
     ...
     */
    void setIndicatorBoundsForTab(XTabLayout tabLayout, View tab, @NonNull Drawable indicator) {
     ...
     *
     * @param tabLayout  The XTabLayout parent of the indicator being drawn.
